                          ...
                          <div class="w-7/8 mx-auto">
                            ...
                            <div class="w-7/8 mx-auto">
                                ...
                                <div class="p-2 w-full mt-4">
                                    <button type="button" onclick="location.href='{{ route('user.posts.index')}}'" class="text-white bg-blue-500 border-0 py-2 px-8 focus:outline-none hover:bg-blue-600 rounded text-lg">戻る</button>
                                </div>
                            </div>
                        </div>
                    </section>
