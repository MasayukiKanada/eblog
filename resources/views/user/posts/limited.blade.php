<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-white leading-tight md:mb-0 mb-3">
            会員限定投稿一覧
        </h2>
        <form method="get" action="{{ route('user.posts.index') }}">
            <div class="sm:flex sm:justify-end items-center mb-3">
                <div class="flex items-center">
                    ...
                    <div><button class=" bg-gray-200 border-0 py-2 px-6 focus:outline-none hover:bg-gray-300 rounded text-lg text-center ml-3">検索</button></div>
                </div>
            </div>
                ...
                <div class="sm:mb-0 mb-5">
                    <div class="flex">
                        <div class="flex items-center mr-2">
                            <p class="text-sm mr-2 text-white">表示順</p>
