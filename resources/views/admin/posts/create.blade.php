                          ...
                          <form method="post" action="{{ route('admin.posts.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="w-7/8 mx-auto">
                                ...
                                <div class="p-2 w-full">
                                    ...
                                    <textarea id="body" name="body" value="{{ old('body') }}" required class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"></textarea>
                                    </div>
                                </div>
                                <div class="p-2 md:w-2/3 w-full">
                                    <div class="relative">
                                        <label for="thumnail" class="leading-7 text-sm text-gray-600">アイキャッチ画像</label>
                                        <input type="file" id="thumnail" name="thumnail" accept="image/png,image/jpeg,image/jpg" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                    </div>
                                </div>
                                <div class="flex items-center">
                                    <div class="p-2 sm:w-1/2 w-full">
                                        <div class="relative">
                                            ...
                                            <select name="for_user" class="bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-5 px-5 leading-6 transition-colors duration-200 ease-in-out w-full">
                                                <option selected value="0">限定にしない</option>
                                                <option value="1">限定にする</option>
                                            </select>
                                            </div>
                                        </div>
                                        <div class="p-2 sm:w-1/2 w-full">
                                    ...
                                    <div class="p-2 w-full">
                                        ...
                                        <input type="datetime-local" id="posted_at" name="posted_at" value="{{ old('posted_at') }}" required class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                        </div>
                                    </div>
